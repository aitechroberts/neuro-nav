#!/bin/bash
# Run the complete Phi-3-Vision-based scene graph pipeline
...
echo "========================================="
echo "Phi-3-Vision Scene Graph Pipeline"
echo "========================================="
echo ""
...
echo "Step 1/4: Extracting node captions with Phi-3-Vision..."
...
echo "  python query_phi3_scene.py \\"
