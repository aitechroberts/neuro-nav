#!/bin/bash
# Run the complete PaliGemma-based scene graph pipeline
...
echo "========================================="
echo "PaliGemma Scene Graph Pipeline"
echo "========================================="
echo ""
...
echo "Step 1/4: Extracting node captions with PaliGemma..."
...
echo "  python query_paligemma_scene.py \\"
